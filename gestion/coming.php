...
<div class="row m-0">
        <div class="offset-md-4 col-md-6 flex-column text-center">
            <h4>Ajouter un film dans la catégorie prochainement</h2>
            ...
            <form method="POST" action="submit.php" id="formhead" class="disabled col-md-12">
                ...
                <input type="text" name="todo" value="next" hidden>
...
<div class="row m-0 mt-3">
        <div class="offset-md-3 col-md-8 text-center">
            <h2>Gérer les arrivées cinéma</h2>
            <p>Dans ce panneau, vous pouvez gérer les films arrivant prochainement</p>            
            <div class="col-md-12">
            <?php 
                include("connect.php");
                $reponse = $bdd->query('SELECT ID,TITLEID, MOVIEID, CONTENTID, POSTERID, BACKDROPID FROM prochcine');
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid row">
                                        ...
                                        <form method="POST" action="update.php" class="col-12 col-md-12">
                                            ...
                                            <input type="text" name="target-category" value="next" hidden>
