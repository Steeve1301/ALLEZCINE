...
<div class="row m-0">
        <div class="offset-md-4 col-md-6 flex-column text-center">
            <h4>Ajouter un film en en-tête</h2>
            ...
            <form method="POST" action="submit.php" id="formhead" class="disabled col-md-12">
                ...
                <textarea class="col-md-8" type="text" name="idcontent" id="content-id" hidden>
                </textarea>

                <input type="text" name="todo" value="head" hidden>
...
<div class="row m-0 mt-3">
        <div class="offset-md-4 col-md-6 flex-column text-center">
            <h2>Gérer les films en en-tête</h2>
            <p>Dans ce panneau, vous pouvez choisir le(s) film(s) à retirer de votre en-tête de page!</p>            
            <div class="col-md-12">
            <?php 
                include("connect.php");
                $reponse = $bdd->query('SELECT ID,TITLEID, MOVIEID, CONTENTID, POSTERID, BACKDROPID FROM headermovie');
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid row">
                                        ...
                                        <form method="POST" action="update.php" class="col-12 col-md-12">
                                            ...
                                            <input type="text" name="target-category" value="head" hidden>
